  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full gap-6 px-6">
        ...
        <p className="text-white/70 font-body text-center max-w-xs">
          Your wallet address is your account. No signup required.
        </p>

        {/* Spending cap — sets the ERC-7715 grant amount */}
        <div className="text-center">
          <p className="font-display text-[11px] uppercase tracking-[0.1em] text-white/60 mb-3">Set spending cap</p>
          ...
          <p className="font-body text-[11px] text-white/55 mt-2">Agents charge 0.20–0.60 USDC per task · Unused budget is never spent</p>
        </div>

        <ConnectButton onConnected={onConnected} budgetUsdc={budget} />
        <p className="font-body text-xs text-white/55 text-center tracking-wide">
